...
public class AppConfig {
    ...
    public String dbUrl() {
        return properties.getProperty("db.url", properties.getProperty("spring.datasource.url"));
    }

    public String dbUser() {
        return properties.getProperty("db.user", properties.getProperty("spring.datasource.username"));
    }

    public String dbPassword() {
        return properties.getProperty("db.password", properties.getProperty("spring.datasource.password", ""));
    }
